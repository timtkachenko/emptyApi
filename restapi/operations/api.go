...
func NewAPI(spec *loads.Document) *API {
	return &API{
		...
		KeyHandler: KeyHandlerFunc(func(params KeyParams) middleware.Responder {
			return middleware.NotImplemented("operation Key has not yet been implemented")
		}),
		PostHandler: PostHandlerFunc(func(params PostParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation Post has not yet been implemented")
		}),

		// Applies when the "x-token" header is set
		BearerAuth: func(token string) (interface{}, error) {
			return nil, errors.NotImplemented("api key auth (Bearer) x-token from header param [x-token] has not yet been implemented")
		},
...
type API struct {
	...
	// KeyHandler sets the operation handler for the key operation
...
func (o *API) Validate() error {
	...
	if o.KeyHandler == nil {
		unregistered = append(unregistered, "KeyHandler")
	}
...
func (o *API) initHandlerCache() {
	...
	o.handlers["GET"]["/{id}"] = NewGet(o.context, o.GetHandler)
	...
	o.handlers["GET"]["/key"] = NewKey(o.context, o.KeyHandler)
